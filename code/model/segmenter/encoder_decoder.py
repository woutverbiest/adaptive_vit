...
if 'CustomEncoderDecoder' not in SEGMENTORS:
    @SEGMENTORS.register_module()
    class CustomEncoderDecoder(BaseSegmentor):
        """Encoder Decoder segmentors.
    
        CustomEncoderDecoder typically consists of backbone, decode_head, auxiliary_head.
        ...
        def __init__(self,
                     ...
                     pretrained=None,
                     init_cfg=None):
            super(CustomEncoderDecoder, self).__init__(init_cfg)
        ...
        def encode_decode(self, img, img_metas):
            ...
            self.encode_times.append(end_encode - start_encode)
            ...
            self.decode_times.append(end_decode - start_decode)
