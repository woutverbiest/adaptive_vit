_base_ = [
    # '../../benchmarking/SegVit_test_2/configs/_base_/models/seg_vit-b16.py',
    '../utils/centercrop.py',
    '../model/backbone/token_reducing_vit.py',
    '../model/segmenter/encoder_decoder.py',
    '../../benchmarking/SegVit_test_2/configs/_base_/datasets/coco-stuff10k.py', 
    '../../benchmarking/SegVit_test_2/configs/_base_/default_runtime.py',
    '../../benchmarking/SegVit_test_2/configs/_base_/schedules/schedule_80k.py'
]
in_channels = 1024
img_size = 512
device = 'cpu'
